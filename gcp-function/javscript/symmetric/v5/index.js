...
// DB connection (Cloud SQL or public dev host)
const pool = new Pool({
...
async function saveMessageToDb({ groupId, meetingId, decrypted, encrypted, raw }) {
  ...
  try {
    ...
    const query = `
      INSERT INTO sms_meeting_log (group_id, meeting_id, meeting_ended_at, encrypted_payload, decrypted_message, raw_sms)
      VALUES ($1, $2, $3, $4, $5, $6)
